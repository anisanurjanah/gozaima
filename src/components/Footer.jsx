                ...
                <div className="footer-wrapper">
                    <div className="footer-grid">
                        <div>
                            <div className="footer-brand">
                                <img src="img/1_GOZAIMA.png" alt="Logo Gozaima" className="h-12" />
                            </div>
                                    ...
                                    <li>
                                        ...
                                        >
                                            <svg
                                                ...
                                                className="footer-link-contact-icon"
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke="currentColor"
                                                strokeWidth="2"
                    ...
                    <div className="footer-bottom">
                        <div className="footer-bottom-content">
                            ...
                            <p className="footer-bottom-text sm:order-first sm:mt-0">&copy; 2025 NEilR</p>
                        </div>
                    </div>
                </div>
            </footer>
